...
const append = (doctors) => {
    doctors.forEach(element => {
        ...
        doctor_name.textContent ="NAME: " + element.first_name+" " +element.last_name
        ...
        doctor_info.append(doctor_img,doctor_name,doctor_exp, doctor_fees,doctor_slots, booknow)
